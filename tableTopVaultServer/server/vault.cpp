...
int main(int argc, char** argv) {
  try {
    ...
    NGINX::instance().generateNginxConfig(ROOT_DIR + "/server/nginx/nginx.conf.template",
                                          ROOT_DIR + "/server/nginx/nginx.conf");

    system(
        "/home/n1/Desktop/tableTopCC/tableTopVaultServer/server/nginx-1.29.1/sbin/nginx -c "
        "/home/n1/Desktop/tableTopCC/tableTopVaultServer/server/nginx/nginx.conf");
