...
module.exports = {
  ...
  entry: {
    ...
    vault: path.resolve(__dirname, "vault", "index.tsx"),
    mongo: path.resolve(__dirname, "mongo", "index.tsx"),
  },
  output: {
    path: outDir,
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      chunks: ["vault"],
      template: path.resolve(__dirname, "vault", "public", "vault.html"),
      filename: "vault/public/vault.html",
      inject: "body",
      minify: isProd,
    }),
    new HtmlWebpackPlugin({
      chunks: ["mongo"],
      template: path.resolve(__dirname, "mongo", "public", "mongo.html"),
      filename: "mongo/public/mongo.html",
      inject: "body",
      minify: isProd,
    }),
  ],
